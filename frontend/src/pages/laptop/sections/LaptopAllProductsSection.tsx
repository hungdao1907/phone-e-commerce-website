...
export function LaptopAllProductsSection({ config, products }: LaptopAllProductsSectionProps) {
  const [activeFilter, setActiveFilter] = useState<LaptopFilter>('popular');
      ...
      <div className="mx-auto w-full max-w-7xl">
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (active
                      ? 'border-[var(--laptop-accent)] bg-white text-[var(--laptop-accent)] shadow-[0_4px_14px_rgba(15,23,42,0.08)]'
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {filteredProducts.map((product) => (
            <LaptopProductCard key={product.id} product={product} />
          ))}
        </div>
      </div>
    </section>
