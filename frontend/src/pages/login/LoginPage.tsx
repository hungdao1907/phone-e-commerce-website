...
const SignInForm = () => (
  <div className="space-y-5 w-full max-w-sm mx-auto">
    ...
    <form className="space-y-3.5" onSubmit={(e) => e.preventDefault()}>
      ...
      <button type="submit" className="w-full h-10 mt-1 rounded-lg bg-[#99e300] hover:bg-[#88ca00] text-black font-semibold text-sm tracking-wider cursor-pointer shadow-[0_2px_8px_rgba(153,227,0,0.15)] active:scale-[0.98] transition-all">
        ĐĂNG NHẬP
      </button>
    </form>
  </div>
