...
export const IPHONE_BRAND_CONFIG: BrandConfig = {
  ...
  featuredBadgeText: '🔥 ƯU ĐÃI ĐẶC BIỆT',
  featuredHeadlinePrefix: 'Giảm Giá Sốc – Mua iPhone',
  featuredHeadlineHighlight: 'Giá Tốt',
  featuredDescription: 'Săn ngay những sản phẩm đang có ưu đãi hấp dẫn với mức giá tốt nhất.',
