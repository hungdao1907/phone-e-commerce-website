...
const appleImage = '/images/watch/ipad-prototype.svg';
const samsungImage = '/images/watch/galaxy-tab-prototype.svg';
const xiaomiImage = '/images/watch/xiaomi-pad-prototype.svg';
...
export const WATCH_BRAND_PRODUCTS: WatchBrandModel[] = [
  ...
  createWatchBrand(
    ...
    'Một không gian watch cao cấp cho đa nhiệm, sáng tạo và giải trí.',
    26990000,
    samsungImage,
    [
  ...
  createWatchBrand(
    ...
    'Một watch dễ tiếp cận cho giải trí, kết nối và các công việc nhẹ nhàng.',
    8990000,
    samsungImage,
    [
  ...
  createWatchBrand(
    ...
    'Một watch linh hoạt cho học tập, làm việc và giải trí trên màn hình rộng.',
    10990000,
    xiaomiImage,
    [
      { name: 'Graphite', hex: '#4A4A49' },
